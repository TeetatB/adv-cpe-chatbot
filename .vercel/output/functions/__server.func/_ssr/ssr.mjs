...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-RUj84_oP.mjs");
...
var manifest = { "3e1c08b2eff370a85fd0b447dc43c5b75431f7b64ce36d3b230fb427c9856d7c": {
	functionName: "sendChat_createServerFn_handler",
	importer: () => import("./chat-api-jAt6X6mJ.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ctd7oy5f.mjs").then((n) => n.t),
